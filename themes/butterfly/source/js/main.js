document.addEventListener('DOMContentLoaded', function () {
  ...
  const addHighlightTool = () => {
    ...
    const highlightCopyEle = highlightCopy ? '<div class="copy-notice"></div><i class="iab carbon--copy copy-button"></i>' : ''
  ...
  */
  ...
  const rightSideFn = {
    readmode: () => { // read mode
      ...
      newEle.type = 'button'
      newEle.className = 'iab carbon--close-outline exit-readmode'
